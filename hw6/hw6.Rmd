...
```
The elbow plot suggests k=4 (The minimum number of groups that suggests drastic changes from one to another.
This is not quite consistent with my impression from question 2. From the dendrogram, I thought there are 3 clusters.
